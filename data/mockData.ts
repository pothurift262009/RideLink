...
export const mockUsers: User[] = [
  {
    ...
    trustScore: 4.8,
    reviews: [
      { id: 'r1', raterId: 'u3', rating: 5, comment: 'Priya is an excellent and safe driver. The car was clean and the journey was very smooth. Highly recommend!' },
      { id: 'r2', raterId: 'u4', rating: 5, comment: 'Very punctual and professional. Felt very safe throughout the trip from Chennai to Bangalore.' },
      { id: 'r3', raterId: 'u5', rating: 4, comment: 'Good driver, friendly conversation. A bit of a delay in starting but made up for it.' },
    ],
  },
  {
    id: 'user_2',
    ...
    trustScore: 4.5,
    reviews: [
      { id: 'r4', raterId: 'u6', rating: 5, comment: 'Arjun is a great co-passenger to have. On time and respectful.' },
      { id: 'r5', raterId: 'u7', rating: 4, comment: 'The drive was great, but the music was a bit too loud for my taste. Otherwise, a solid 4 stars.' },
    ],
  },
  {
    id: 'user_3',
    ...
    trustScore: 4.9,
    reviews: [
        { id: 'r6', raterId: 'u1', rating: 5, comment: 'Anjali is the best! Very safe driver, super clean car, and she even offered snacks. It felt like travelling with a friend.' },
        { id: 'r7', raterId: 'u2', rating: 5, comment: 'On time, professional, and a very comfortable ride. The women-only option is a fantastic feature.' },
    ]
  },
   {
    id: 'user_4',
    ...
    trustScore: 3.2,
    reviews: [
        { id: 'r8', raterId: 'u9', rating: 3, comment: 'The ride was okay, but the driver was 30 minutes late for pickup.' },
