    ...
    >
      ...
      >
        <div className="text-center">
            ...
            <h3 className="mt-5 text-lg leading-6 font-bold text-gray-900">
                Cancel your ride?
            </h3>
            <div className="mt-2 px-7 py-3">
                <p className="text-sm text-gray-500">
                    Are you sure you want to cancel your ride from <span className="font-semibold">{ride.from}</span> to <span className="font-semibold">{ride.to}</span> with {driver.name}?
                </p>
            </div>
