              ...
              <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1">
                      <div className="flex justify-between items-center mb-2">
                          <h4 className="flex items-center gap-2 text-md font-bold text-gray-800 dark:text-slate-200">
              ...
              {!isOwnProfile && (
                  <div className="mt-6 border-t border-slate-200 dark:border-slate-700 pt-5">
                      <button
                          ...
                          className="w-full flex items-center justify-center gap-2 bg-indigo-600 text-white font-bold py-3 px-6 rounded-lg transition-all text-lg hover:bg-indigo-700"
                      >
